...
class CConsole : public IConsole
{
	...
	public:
		...
		virtual const CCommandInfo *NextCommandInfo() const;
	};
	...
	//help command
	static void ConHelp(IResult *pResult, void *pUser);
	static void ConHelpRcon(IResult *pResult, void *pUser);
...
public:
	...
	virtual const CCommandInfo *FirstCommandInfo() const;
	virtual const CCommandInfo *GetCommandInfo(const char *pName, bool Temp);
	virtual void PossibleCommands(const char *pStr, bool Temp, FPossibleCallback pfnCallback, void *pUser);

	virtual void PossibleCommandsList(bool Temp, void *pUser);

	virtual void ParseArguments(int NumArgs, const char **ppArguments);
	virtual void Register(const char *pName, const char *pParams, FCommandCallback pfnFunc, void *pUser, const char *pHelp);
	virtual void RegisterTemp(const char *pName, const char *pParams, const char *pHelp);
