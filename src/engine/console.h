...
public:
	...
	public:
		...
		virtual const CCommandInfo *NextCommandInfo() const = 0;
	};
	...
	virtual const CCommandInfo *FirstCommandInfo() const = 0;
	virtual const CCommandInfo *GetCommandInfo(const char *pName, bool Temp) = 0;
	virtual void PossibleCommands(const char *pStr, bool Temp, FPossibleCallback pfnCallback, void *pUser) = 0;
	virtual void ParseArguments(int NumArgs, const char **ppArguments) = 0;

	virtual void Register(const char *pName, const char *pParams, FCommandCallback pfnFunc, void *pUser, const char *pHelp) = 0;
	virtual void RegisterTemp(const char *pName, const char *pParams, const char *pHelp) = 0;
